...
export const SECTOR_ENVIRONMENTS = Object.freeze([
  ...
  {
    id: "nairan-expanse",
    gradient: ["#0a0713", "#100d20", "#04050c"],
    farLayer: "nairanEnvironmentFar", edgeLayer: "nairanEnvironmentEdge",
    farAlpha: 0.34, edgeAlpha: 0.32, farDrift: [2, 4], edgeDrift: [1, 6],
    tintAlpha: 0.035,
  ...
  {
    id: "nautolan-depths",
    gradient: ["#030b0b", "#071713", "#020706"],
    farLayer: "nautolanEnvironmentFar", edgeLayer: "nautolanEnvironmentEdge",
    farAlpha: 0.31, edgeAlpha: 0.32, farDrift: [3, 4], edgeDrift: [1, 7],
    tintAlpha: 0.03,
  ...
  {
    id: "void-core",
    gradient: ["#070307", "#10060b", "#020104"],
    farLayer: "nautolanVoidEnvironmentFar", edgeLayer: "nautolanVoidEnvironmentEdge",
    farAlpha: 0.34, edgeAlpha: 0.30, farDrift: [2, 4], edgeDrift: [1, 6],
    tintAlpha: 0.035,
